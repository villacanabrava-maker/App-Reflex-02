...
1. **Trabalho em Branch Curta:**
   - Todo trabalho deve ser realizado em branch de feature/fix: eature/nome-da-frente ou ix/nome-do-ajuste.
   - Push direto na branch main é proibido e bloqueado pelos hooks.

2. **Critérios de Build e Qualidade:**
   - Nenhum PR pode ser aberto com erros de TypeScript (
pm run typecheck ou 
px tsc --noEmit), lint ou falhas de testes.
