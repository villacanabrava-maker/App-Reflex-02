...
const binaryExtensions = /\.(?:png|jpe?g|gif|webp|ico|pdf|zip|gz|tgz|tar|woff2?|ttf|otf|eot|mp3|mp4|mov|avi|wasm)$/i;
const files = [...new Set([
  ...roots.flatMap((dir) => walkFiles(dir)).filter((path) => !binaryExtensions.test(path)),
  ...rootFiles,
])];
